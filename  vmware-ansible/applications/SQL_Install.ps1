...
#   Last Update Date: 31/01/19
###########################################################################

#Script will:
# - Create local sqladmin account
# - generate random passwords and create sql agent adn sql service accounts
# - amend local security policy to allow local login for new accounts
# - edit INI file for installation
# - start installation of SQL

# Params

$cmdfile = "" #location of CMD file for SQL install
$workingDir = "" #location of .tmp file for SQL install
$installtemplate = "" #standalone INI File
$installtemplatetmp = "" #standalone tmp file
$sqladmin_key = "" #key file location for sqladmin pw
$sqladmin_pw = "" #pw file location for sqladmin pw
$ansible_ad = #credentials for ansible account
